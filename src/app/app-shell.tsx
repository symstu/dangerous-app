...
import { suppressMetaMaskSessionRejections } from "@/lib/ethereum-provider";
...
const WalletSidebar = dynamic(() => import("@/components/wallet-sidebar"), {
  ssr: false,
});
...
function AppProviders({ children }: { children: React.ReactNode }) {
  useEffect(() => {
    ...
    suppressMetaMaskSessionRejections();
  }, []);
